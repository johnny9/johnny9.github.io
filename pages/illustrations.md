...
Below are the three illustrations used during the [first-use]({{ '/first-use/' | relative_url }}) process. They represent "network", "block status", and "initial block download".
